...
test('copies Obsidian files to the associated output directories', async () => {
  ...
  expect(mkdirSpy).toHaveBeenNthCalledWith(1, osPath('src/assets/notes'), { recursive: true })
  expect(copyFileSpy).toHaveBeenNthCalledWith(1, 'baz.png', osPath('src/assets/notes/baz.png'))

  expect(mkdirSpy).toHaveBeenNthCalledWith(2, osPath('public/notes/nested'), { recursive: true })
  expect(copyFileSpy).toHaveBeenNthCalledWith(2, 'nested/qux.pdf', osPath('public/notes/nested/qux.pdf'))

  expect(readFileSpy).toHaveBeenNthCalledWith(2, 'foo.md', 'utf8')
  expect(mkdirSpy).toHaveBeenNthCalledWith(3, osPath('src/content/docs/notes'), { recursive: true })
  expect(writeFileSpy).toHaveBeenNthCalledWith(1, osPath('src/content/docs/notes/foo.md'), expect.any(String))

  expect(readFileSpy).toHaveBeenNthCalledWith(3, 'nested/bar.md', 'utf8')
  expect(mkdirSpy).toHaveBeenNthCalledWith(4, osPath('src/content/docs/notes/nested'), { recursive: true })
  expect(writeFileSpy).toHaveBeenNthCalledWith(2, osPath('src/content/docs/notes/nested/bar.md'), expect.any(String))
})
...
test('copies content files to a custom output directory', async () => {
  ...
  expect(mkdirSpy).toHaveBeenNthCalledWith(1, osPath('public/test'), { recursive: true })
  expect(copyFileSpy).toHaveBeenNthCalledWith(1, 'bar.webm', osPath('public/test/bar.webm'))
  expect(mkdirSpy).toHaveBeenNthCalledWith(2, osPath('src/content/docs/test'), { recursive: true })
  expect(writeFileSpy).toHaveBeenNthCalledWith(1, osPath('src/content/docs/test/foo.md'), expect.any(String))
})
...
Test`)
  ...
  expect(mkdirSpy).toHaveBeenNthCalledWith(1, osPath('src/content/docs/notes/folder'), { recursive: true })
  expect(writeFileSpy).toHaveBeenNthCalledWith(1, osPath('src/content/docs/notes/folder/foo.md'), expect.any(String))

  expect(mkdirSpy).toHaveBeenNthCalledWith(2, osPath('public/notes/folder/foo'), { recursive: true })
...
published`)
  ...
  expect(mkdirSpy).toHaveBeenNthCalledWith(1, osPath('src/content/docs/notes'), { recursive: true })
  expect(writeFileSpy).toHaveBeenNthCalledWith(1, osPath('src/content/docs/notes/bar.md'), expect.any(String))

  expect(mkdirSpy).toHaveBeenNthCalledWith(2, osPath('src/content/docs/notes'), { recursive: true })
  expect(writeFileSpy).toHaveBeenNthCalledWith(2, osPath('src/content/docs/notes/qux.md'), expect.any(String))
})
...
test('clears the default output directories', async () => {
  ...
  expect(rmSpy).toHaveBeenNthCalledWith(1, osPath('src/assets/notes'), { force: true, recursive: true })
  expect(rmSpy).toHaveBeenNthCalledWith(2, osPath('src/content/docs/notes'), { force: true, recursive: true })
  expect(rmSpy).toHaveBeenNthCalledWith(3, osPath('public/notes'), { force: true, recursive: true })
})
